...
Validation: generated-source freshness and safe SVG contracts; native Tabler rendering; Departure font loading; light/dark switching and default palette fallback; five native reloads; disable/enable restoration; responsive screenshot matrix. `scripts/host-qa.mjs` records the computed font and active Tabler node count.
