...
console.log(JSON.stringify({$schema:'https://getbb.app/schemas/marketplace.schema.json',schemaVersion:1,name:'kujo',displayName:'Kujo',description:'Kujo design-system adapters for bb.',plugins:[{id:'bb-kujo',displayName:'Kujo',description:'A mechanical workspace skin based on Kujo and SiteKit.',icon:{url:'assets/kujo-mark.svg'},category:'themes-and-appearance',tags:['theme','kujo','sitekit'],screenshots:['editor-files','terminal','preview-thread'].map(name=>repo.replace('github.com','raw.githubusercontent.com')+'/main/screenshots/'+name+'.png'),author:{name:'Robert DeVore',github:'robertdevore'},source:{git:{url:repo,ref:'main'}}}]},null,2));
