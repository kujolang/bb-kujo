...
for(const [role,key] of [['addition','success'],['deletion','danger']]) {
 ...
 map[`diffs-bg-${role}-emphasis-override`]=`color-mix(in srgb, ${v(key)} ${mode === 'light' ? 18 : 24}%, ${v('canvas')})`;
}
